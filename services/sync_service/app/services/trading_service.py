...
CORE_SERVICE_URL = os.environ.get("CORE_SERVICE_URL", "http://127.0.0.1:8001")
MESSAGING_SERVICE_URL = os.environ.get("MESSAGING_SERVICE_URL", "http://127.0.0.1:8003")
...
class TradingService:
    ...
    async def broadcast_signal(self, signal: TradingSignal) -> tuple[bool, str]:
        ...
        from app.utils.strategy import SRBounceRejection
    ...
    async def check_signals(self, symbol: str):
        ...
        try:
            from app.utils.indicators import PriceActionIndicators as Indicators
            from app.utils.strategy import SRBounceRejection as Strategy
            from app.utils.trading_utils import filter_last_trading_days
