...
from sqlalchemy import String, ForeignKey, Float, DateTime, BigInteger, Integer
...
class BrokerAccount(Base):
    ...
    orders: Mapped[List["Order"]] = relationship(back_populates="broker_account", cascade="all, delete-orphan")
    positions: Mapped[List["Position"]] = relationship(back_populates="broker_account", cascade="all, delete-orphan")

class Order(Base):
    __tablename__ = "orders"

    id: Mapped[int] = mapped_column(BigInteger, primary_key=True)
    broker_account_id: Mapped[int] = mapped_column(ForeignKey("broker_accounts.id", ondelete="CASCADE"))
