...
async def test_receive_whatsapp_message_flow(msg_client: AsyncClient, mocker):
    ...
    mock_httpx.get.return_value = Response(200, json={"id": 1, "phone_number": "123456789"})
    ...
    mocker.patch("services.bot_service.agent_executor.ainvoke", return_value={"messages": [mock_ai_resp]})
    ...
    mocker.patch("services.messaging_service.app.main.Message", return_value=mocker.Mock(
        is_message=True,
        number="123456789",
        text="Hello Bot",
        id="msg_123"
